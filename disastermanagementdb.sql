...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2026 at 08:43 AM
...
INSERT INTO `organization` (`Organization_ID`, `Organization_Name`, `Address`, `Contact_No`, `Email`) VALUES
...
INSERT INTO `victim` (`Victim_ID`, `NID`, `Shelter_ID`, `Zone_ID`, `Full_Name`, `Age`, `Gender`, `Family_Size`, `Medical_Status`, `Contact_No`) VALUES
...
INSERT INTO `volunteer` (`Volunteer_ID`, `Organization_ID`, `Zone_ID`, `Full_Name`, `Phone`, `Gender`, `Skill`, `Availability`) VALUES
